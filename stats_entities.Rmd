...
cat(paste0("\n## <a href='#mobKills_perPerson' id='mobKills_perPerson'>4</a>. Mob Kills per Person"))
cat("\n")
cat(paste0("![mobKills_perPerson](/wurstminestats/entities/mobKills_perPerson.png)"))
cat("\n")
...
cat(paste0("\n## <a href='#mobKills_perPerson_noendermen' id='mobKills_perPerson_noendermen'>4.1</a>. Mob Kills per Person (except Endermen)"))
cat("\n")
cat(paste0("![mobKills_perPerson_noendermen](/wurstminestats/entities/mobKills_perPerson_noendermen.png)"))
cat("\n")
...
cat(paste0("\n## <a href='#mobDeaths_perPerson' id='mobDeaths_perPerson'>5</a>. Deaths by Mob per Person"))
cat("\n")
cat(paste0("![mobDeaths_perPerson](/wurstminestats/entities/mobDeaths_perPerson.png)"))
cat("\n")
```
