...
ggsave(plot = p, file = "output/entities/mobKills_perPerson.png", height = plotHeight, width = plotWidth)
...
ggsave(plot = p, file = "output/entities/mobDeaths_perPerson.png", height = plotHeight, width = plotWidth)
